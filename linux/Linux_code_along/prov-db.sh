...
curl -fsSL https://www.mongodb.org/static/pgp/server-7.0.asc | sudo gpg --yes -o /usr/share/keyrings/mongodb-server-7.0.gpg --dearmor #the --yes
echo Done! 
...
# Modify MongoDB configuration to allow remote connections by replacing the BIND I
